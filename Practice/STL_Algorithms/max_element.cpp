...
int main()
{
    ...
    /*
     * std::max_element(ForwardIt first, ForwardIt last) -> ForwardIt
     *  - returns the iterator of the element with maximum value
     */
    const auto itMaxVal{ std::max_element(arr.begin(), arr.end()) };
    std::cout << "Maximum value of the array arr is: " << *itMaxVal << '\n';

    /*
     * std::max_element(ForwardIt first, ForwardIt last, callable object) -> ForwardIt
