...
TEST(MyDBTest, Invoke_IClassFunct)
{
    // ***** Arrange *****
    DataBaseConnect dbc;
    MockDB mdb;
    ...
    .Times(1)
    .WillOnce(testing::Invoke(&dbc, &DataBaseConnect::login));
...
TEST(MyDBTest, Invoke_DummyFunct)
{
    // ***** Arrange *****
    Dummy dm;
    MockDB mdb;
    ...
    EXPECT_CALL(mdb, login("Terminator", "I'm Back"))
    .Times(1)
    .WillOnce(testing::Invoke(&dm, &Dummy::DummyFunct));
