...
// ON_CALL printout is different depending on the number of ON_CALL functions that are called
...
TEST(MyDBTest, On_Call_Once)
{
    ...
    When login0 is called it is printed:
        ...
        C:\Users\rar\..Google_Cpp_Testing_Framework_Series\GoogleMock\On_Call.cpp:87:
...
TEST(MyDBTest, On_Call_Twice)
{
    ...
    When login1 is called it is printed:
        GMOCK WARNING:
        Uninteresting mock function call - taking default action specified at:
        C:\Users\rar\..Google_Cpp_Testing_Framework_Series\GoogleMock\On_Call.cpp:123:
            Function call: login1("Random1", "Random2")
                Returns: true
    */
    ON_CALL(mdb, login0(testing::_, testing::_))
