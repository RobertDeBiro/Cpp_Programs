...
int main()
{
    ...
    // Format "Normal", with showpoint manipulator
    //  - showpoint adds trailing zeros (format normal by default don't show them)
    ...
    //  - in scientific notation there is always only one nmuber before first decimal place
    //  - setprecision count numbers from the first decimal place
    //  - if precision is less than the number of significant digits, the number will be rounded
    //  - adds trailing zeros
